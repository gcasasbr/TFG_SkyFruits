...
public class GameControllerMAP2 : MonoBehaviour
{
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 1);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 2);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 3);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 4);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 5);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 6);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 7);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 8);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
    ...
    {
        PlayerPrefs.SetInt("pantallaSeleccionadaMON1", 9);
        PlayerPrefs.SetInt("pantallaSeleccionada", 0);
