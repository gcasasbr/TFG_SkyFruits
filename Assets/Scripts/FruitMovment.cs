...
public class FruitMovment : MonoBehaviour
{
    ...
    public GameObject contadorTomaquet;
    public GameObject contadorFresa;
    public GameObject contadorMelo;
    ...
    void Start()
    {
        ...
        contadorFresa= GameObject.Find("Fruit_Red_1 (8) Variant");
        contadorLlimona = GameObject.Find("Fruit_Green_2(19)");
