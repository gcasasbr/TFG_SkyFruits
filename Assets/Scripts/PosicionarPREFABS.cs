        ...
        case "Scene2":
         ...
         case "Scene8":
            ...
            case "Scene18":
                ...
                Instantiate(Tomaquet, posicioX1Y1, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y3, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y4, Quaternion.identity);
                Instantiate(Melo, posicioX1Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y6, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y9, Quaternion.identity);

                Instantiate(Melo, posicioX2Y1, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y2, Quaternion.identity);
                Instantiate(Melo, posicioX2Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y7, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Llimona, posicioX3Y6, Quaternion.identity);
                Instantiate(Melo, posicioX3Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y8, Quaternion.identity);
                Instantiate(Melo, posicioX3Y9, Quaternion.identity);

                Instantiate(Melo, posicioX4Y1, Quaternion.identity);
                Instantiate(Melo, posicioX4Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y4, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y5, Quaternion.identity);
                Instantiate(Melo, posicioX4Y6, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y9, Quaternion.identity);

                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y2, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y4, Quaternion.identity);
                Instantiate(Melo, posicioX5Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y6, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y8, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene19":
                ...
                Instantiate(Melo, posicioX1Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y2, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX1Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y4, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y5, Quaternion.identity);
                Instantiate(Cireres, posicioX1Y6, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX1Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y8, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y9, Quaternion.identity);

                Instantiate(Tomaquet, posicioX2Y1, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y2, Quaternion.identity);
                Instantiate(Melo, posicioX2Y3, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX2Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y9, Quaternion.identity);

                Instantiate(Melo, posicioX3Y1, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX3Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y4, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y5, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX3Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y9, Quaternion.identity);
                ...
                Instantiate(Bomba, posicioX5Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y2, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX5Y3, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX5Y4, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y6, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y8, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene20":
                ...
                Instantiate(EstrellaBlava, posicioX1Y1, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y2, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y4, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y5, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX1Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y7, Quaternion.identity);
                Instantiate(Bomba, posicioX1Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y9, Quaternion.identity);

                Instantiate(tomaquetTancat, posicioX2Y1, Quaternion.identity);
                Instantiate(Melo, posicioX2Y2, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX2Y4, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX2Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX2Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX3Y2, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y3, Quaternion.identity);
                Instantiate(Melo, posicioX3Y4, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y5, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y7, Quaternion.identity);
                Instantiate(Melo, posicioX3Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y9, Quaternion.identity);

                Instantiate(tomaquetTancat, posicioX4Y1, Quaternion.identity);
                Instantiate(Bomba, posicioX4Y2, Quaternion.identity);
                Instantiate(meloTancat, posicioX4Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y4, Quaternion.identity);
                Instantiate(Cireres, posicioX4Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y7, Quaternion.identity);
                Instantiate(Melo, posicioX4Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y9, Quaternion.identity);
                ...
                Instantiate(Melo, posicioX5Y2, Quaternion.identity);
                Instantiate(Melo, posicioX5Y3, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y4, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene21":
                ...
                Instantiate(Caixa, posicioX1Y1, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y2, Quaternion.identity);
                Instantiate(taronjaTancada, posicioX1Y3, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y7, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y9, Quaternion.identity);
                ...
                Instantiate(Llimona, posicioX2Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y6, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX4Y1, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y5, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y6, Quaternion.identity);
                Instantiate(Melo, posicioX4Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y8, Quaternion.identity);
                Instantiate(Melo, posicioX4Y9, Quaternion.identity);

                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(taronjaTancada, posicioX5Y2, Quaternion.identity);
                Instantiate(Bomba, posicioX5Y3, Quaternion.identity);
                Instantiate(taronjaTancada, posicioX5Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y5, Quaternion.identity);
                Instantiate(Melo, posicioX5Y6, Quaternion.identity);
                Instantiate(Melo, posicioX5Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y8, Quaternion.identity);
            ...
            case "Scene22":
                ...
                Instantiate(llimonaTancada, posicioX1Y1, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX1Y2, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX1Y3, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX1Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y8, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX1Y9, Quaternion.identity);

                Instantiate(llimonaTancada, posicioX2Y1, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX2Y2, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX2Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y4, Quaternion.identity);
                Instantiate(Bomba, posicioX2Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y6, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX2Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y9, Quaternion.identity);

                Instantiate(llimonaTancada, posicioX3Y1, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX3Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y5, Quaternion.identity);
                ...
                Instantiate(llimonaTancada, posicioX4Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y2, Quaternion.identity);
                Instantiate(Llimona, posicioX4Y3, Quaternion.identity);
                Instantiate(Melo, posicioX4Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX4Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y9, Quaternion.identity);

                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y2, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y3, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX5Y4, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y7, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX5Y8, Quaternion.identity);
            ...
            case "Scene23":
                ...
                Instantiate(Caixa, posicioX1Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y8, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y9, Quaternion.identity);

                Instantiate(meloTancat, posicioX2Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y2, Quaternion.identity);
                Instantiate(meloTancat, posicioX2Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y4, Quaternion.identity);
                Instantiate(Melo, posicioX2Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y7, Quaternion.identity);
                Instantiate(meloTancat, posicioX2Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX3Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y8, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y9, Quaternion.identity);

                Instantiate(meloTancat, posicioX4Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y2, Quaternion.identity);
                Instantiate(Melo, posicioX4Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y4, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y7, Quaternion.identity);
                Instantiate(meloTancat, posicioX4Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y9, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y5, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y8, Quaternion.identity);
                Instantiate(Bomba, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene24":
                ...
                Instantiate(Taronja, posicioX1Y2, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y6, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX1Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y9, Quaternion.identity);

                Instantiate(Llimona, posicioX2Y1, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX2Y2, Quaternion.identity);
                Instantiate(Melo, posicioX2Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y6, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX3Y6, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y7, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y8, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y9, Quaternion.identity);

                Instantiate(Taronja, posicioX4Y1, Quaternion.identity);
                Instantiate(Cireres, posicioX4Y2, Quaternion.identity);
                Instantiate(Melo, posicioX4Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y7, Quaternion.identity);
                Instantiate(Melo, posicioX4Y8, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX4Y9, Quaternion.identity);

                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y2, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX5Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y4, Quaternion.identity);
                Instantiate(Melo, posicioX5Y5, Quaternion.identity);
                Instantiate(Melo, posicioX5Y6, Quaternion.identity);
                Instantiate(Cireres, posicioX5Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene25":
                ...
                Instantiate(Llimona, posicioX1Y1, Quaternion.identity);
                Instantiate(Melo, posicioX1Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y3, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y4, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y5, Quaternion.identity);
                ...
                Instantiate(BombollaBlava, posicioX2Y1, Quaternion.identity);
                Instantiate(Tomaquet, posicioX2Y2, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX2Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y5, Quaternion.identity);
                Instantiate(Cireres, posicioX2Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y7, Quaternion.identity);
                Instantiate(Cireres, posicioX2Y8, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Fresa, posicioX3Y3, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y4, Quaternion.identity);
                Instantiate(Melo, posicioX3Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y9, Quaternion.identity);
                ...
                Instantiate(Cireres, posicioX4Y2, Quaternion.identity);
                Instantiate(Melo, posicioX4Y3, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX4Y4, Quaternion.identity);
                Instantiate(Melo, posicioX4Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y6, Quaternion.identity);
                Instantiate(Bomba, posicioX4Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y8, Quaternion.identity);
                Instantiate(Melo, posicioX4Y9, Quaternion.identity);
                ...
                Instantiate(Tomaquet, posicioX5Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y4, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y6, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y8, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene26":
                ...
                Instantiate(tomaquetTancat, posicioX1Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y2, Quaternion.identity);
                Instantiate(Bomba, posicioX1Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y4, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX1Y6, Quaternion.identity);
                Instantiate(Cireres, posicioX1Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y8, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX1Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX2Y6, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y7, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX2Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y9, Quaternion.identity);

                Instantiate(BombollaBlava, posicioX3Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y2, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX3Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y5, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y6, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX3Y7, Quaternion.identity);
                Instantiate(Melo, posicioX3Y8, Quaternion.identity);
                Instantiate(Cireres, posicioX3Y9, Quaternion.identity);

                Instantiate(Fresa, posicioX4Y1, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y2, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y3, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX4Y4, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y5, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX4Y6, Quaternion.identity);
                Instantiate(meloTancat, posicioX4Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y9, Quaternion.identity);
                ...
                Instantiate(meloTancat, posicioX5Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y8, Quaternion.identity);
                Instantiate(Melo, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene31":
                ...
                Instantiate(Llimona, posicioX1Y6, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX1Y7, Quaternion.identity);
                Instantiate(Melo, posicioX1Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y9, Quaternion.identity);

                Instantiate(Caixa, posicioX2Y1, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y2, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y4, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX2Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y6, Quaternion.identity);
                Instantiate(Tomaquet, posicioX2Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX3Y1, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y2, Quaternion.identity);
                Instantiate(Bomba, posicioX3Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y5, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX3Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y8, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y9, Quaternion.identity);

                Instantiate(Melo, posicioX4Y1, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX4Y2, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX4Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y4, Quaternion.identity);
                Instantiate(Melo, posicioX4Y5, Quaternion.identity);
                Instantiate(Melo, posicioX4Y6, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y3, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX5Y4, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX5Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y6, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y8, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene32":
                ...
                Instantiate(Tomaquet, posicioX1Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y3, Quaternion.identity);
                Instantiate(Melo, posicioX1Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y5, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y8, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX3Y1, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y3, Quaternion.identity);
                Instantiate(Melo, posicioX3Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y5, Quaternion.identity);
                Instantiate(Melo, posicioX3Y6, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX5Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene33":
                ...
                Instantiate(Caixa, posicioX1Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y7, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y8, Quaternion.identity);
                Instantiate(Melo, posicioX1Y9, Quaternion.identity);

                Instantiate(taronjaTancada, posicioX2Y1, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y2, Quaternion.identity);
                Instantiate(Cireres, posicioX2Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y6, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX2Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y8, Quaternion.identity);
                Instantiate(Melo, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Tomaquet, posicioX4Y7, Quaternion.identity);
                Instantiate(Melo, posicioX4Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y9, Quaternion.identity);

                Instantiate(Llimona, posicioX5Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y2, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX5Y3, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y6, Quaternion.identity);
                Instantiate(Melo, posicioX5Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y8, Quaternion.identity);
            ...
            case "Scene34":
                ...
                Instantiate(Fresa, posicioX1Y4, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX1Y5, Quaternion.identity);
                Instantiate(Melo, posicioX1Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y8, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y9, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX2Y1, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX2Y3, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y4, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y6, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y7, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX2Y8, Quaternion.identity);
                Instantiate(Tomaquet, posicioX2Y9, Quaternion.identity);

                Instantiate(Caixa, posicioX3Y1, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y2, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y5, Quaternion.identity);
                Instantiate(Melo, posicioX3Y6, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX3Y7, Quaternion.identity);
                Instantiate(Melo, posicioX3Y8, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y9, Quaternion.identity);

                Instantiate(EstrellaBlava, posicioX4Y1, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX4Y2, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y3, Quaternion.identity);
                Instantiate(Melo, posicioX4Y4, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX4Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y6, Quaternion.identity);
                Instantiate(Melo, posicioX4Y7, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y8, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX4Y9, Quaternion.identity);

                Instantiate(Fresa, posicioX5Y1, Quaternion.identity);
                Instantiate(Melo, posicioX5Y2, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y4, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y5, Quaternion.identity);
            ...
            case "Scene35":
                ...
                Instantiate(Tomaquet, posicioX2Y3, Quaternion.identity);
                Instantiate(Melo, posicioX2Y4, Quaternion.identity);
                Instantiate(meloTancat, posicioX2Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y7, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX2Y8, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Llimona, posicioX4Y3, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y4, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX4Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y7, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX4Y8, Quaternion.identity);
                Instantiate(Melo, posicioX4Y9, Quaternion.identity);

                Instantiate(Bomba, posicioX5Y1, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y2, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y5, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y6, Quaternion.identity);
                Instantiate(Cireres, posicioX5Y7, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX5Y8, Quaternion.identity);
            ...
            case "Scene36":
                ...
                Instantiate(Tomaquet, posicioX1Y4, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y5, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y6, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y7, Quaternion.identity);
                Instantiate(Melo, posicioX1Y8, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX2Y3, Quaternion.identity);
                Instantiate(Melo, posicioX2Y4, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX2Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y8, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Llimona, posicioX3Y2, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y3, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX3Y4, Quaternion.identity);
                Instantiate(Cireres, posicioX3Y5, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX3Y6, Quaternion.identity);
                Instantiate(taronjaTancada, posicioX3Y7, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y9, Quaternion.identity);
                ...
                Instantiate(Caixa, posicioX5Y1, Quaternion.identity);
                Instantiate(Melo, posicioX5Y2, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX5Y3, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y4, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y5, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y7, Quaternion.identity);
            ...
            case "Scene37":
                ...
                Instantiate(Tomaquet, posicioX1Y2, Quaternion.identity);
                Instantiate(Tomaquet, posicioX1Y3, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX1Y4, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y6, Quaternion.identity);
                Instantiate(taronjaTancada, posicioX1Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX1Y8, Quaternion.identity);
                Instantiate(Bomba, posicioX1Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX3Y1, Quaternion.identity);
                Instantiate(Bomba, posicioX3Y2, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y3, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX3Y4, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y5, Quaternion.identity);
                Instantiate(Bomba, posicioX3Y6, Quaternion.identity);
                Instantiate(Melo, posicioX3Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y9, Quaternion.identity);
                ...
                Instantiate(Bomba, posicioX5Y1, Quaternion.identity);
                Instantiate(llimonaTancada, posicioX5Y2, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y3, Quaternion.identity);
                Instantiate(Bomba, posicioX5Y4, Quaternion.identity);
                Instantiate(tomaquetTancat, posicioX5Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX5Y6, Quaternion.identity);
                Instantiate(taronjaTancada, posicioX5Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX5Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y9, Quaternion.identity);
            ...
            case "Scene38":
                ...
                Instantiate(meloTancat, posicioX1Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y2, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX1Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX1Y5, Quaternion.identity);
                Instantiate(Melo, posicioX1Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX1Y7, Quaternion.identity);
                ...
                Instantiate(Fresa, posicioX2Y7, Quaternion.identity);
                Instantiate(Taronja, posicioX2Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y9, Quaternion.identity);

                Instantiate(meloTancat, posicioX3Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y2, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX3Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX3Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX3Y6, Quaternion.identity);
                Instantiate(Taronja, posicioX3Y7, Quaternion.identity);
                ...
                Instantiate(meloTancat, posicioX4Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX4Y2, Quaternion.identity);
                Instantiate(meloTancat, posicioX4Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX4Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX4Y5, Quaternion.identity);
                Instantiate(Fresa, posicioX4Y6, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX4Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX4Y9, Quaternion.identity);

                Instantiate(meloTancat, posicioX5Y1, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y2, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y3, Quaternion.identity);
                Instantiate(meloTancat, posicioX5Y4, Quaternion.identity);
                Instantiate(Caixa, posicioX5Y5, Quaternion.identity);
                Instantiate(Melo, posicioX5Y6, Quaternion.identity);
                Instantiate(Fresa, posicioX5Y7, Quaternion.identity);
            ...
            case "Scene39":
                ...
                Instantiate(Taronja, posicioX2Y4, Quaternion.identity);
                Instantiate(EstrellaBlava, posicioX2Y5, Quaternion.identity);
                Instantiate(Melo, posicioX2Y6, Quaternion.identity);
                Instantiate(Llimona, posicioX2Y7, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y8, Quaternion.identity);
                Instantiate(Fresa, posicioX2Y9, Quaternion.identity);
                ...
                Instantiate(Fresa, posicioX3Y5, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y6, Quaternion.identity);
                Instantiate(Tomaquet, posicioX3Y7, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX3Y8, Quaternion.identity);
                Instantiate(Llimona, posicioX3Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX4Y5, Quaternion.identity);
                Instantiate(Taronja, posicioX4Y6, Quaternion.identity);
                Instantiate(Cireres, posicioX4Y7, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y8, Quaternion.identity);
                Instantiate(Tomaquet, posicioX4Y9, Quaternion.identity);
                ...
                Instantiate(Taronja, posicioX5Y5, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX5Y6, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX5Y7, Quaternion.identity);
                Instantiate(Llimona, posicioX5Y8, Quaternion.identity);
                Instantiate(BombollaBlava, posicioX5Y9, Quaternion.identity);
